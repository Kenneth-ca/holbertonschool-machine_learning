...
class Neuron:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05, verbose=True, graph=True, step=100):
        ...
        :param verbose: boolean to define if print information about training
        :param graph: boolean to define if graph information about training
        :param step: step iteration to show information
